...
//Criando array que possui um objeto com dados do usuário (email, phone, ref e refBy)
const users = [
    {
        email: "test@test.com",
        phone: "99999999999",
...
//Função para pegar o total de novos usuários que entraram por um link de um outro usuário
...
//Função que mostra o link de convite do usuário e quantas inscrições foram feitas a partir do seu link 
...
//Definindo o ref e salvando as informações de cadastro dos novos usuários 
...
//Função que captura os valores enviados nos campos E-mail e Telefone
const formAction = () => {
